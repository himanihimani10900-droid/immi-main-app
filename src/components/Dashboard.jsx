...
const Dashboard = () => {
  ...
  // Check if the name/reference section should be clickable
  ...
  // Handle click on name/reference section
  const handleApplicationClick = () => {
    if (shouldBeClickable()) {
      // Navigate to show-pdf route
      navigate('/gov.au/lusc/show-pdf');
    }
  };
                  ...
                  <div>
                    ...
                    >
                      <div
                        style={{
                          ...
                          transition: shouldBeClickable() ? "background-color 0.2s" : "none",
                        }}
                        onClick={handleApplicationClick}
                        // onMouseOver={(e) => {
                        //   if (shouldBeClickable()) {
                        //     e.target.style.backgroundColor = "#C6E7FF";
                        //   }
                        // }}
                        // onMouseOut={(e) => {
                        //   if (shouldBeClickable()) {
                        //     e.target.style.backgroundColor = "#D8EFFD";
                        //   }
                        // }}
                      >
                        <div style={{ flex: 1, width: "100%" }}>
                          <strong
                            style={{
                              color: shouldBeClickable() ? "#0066cc" : "#0B6B9A",
                              display: "block",
                              fontSize: isMobile ? "12px" : "15px",
                              textDecoration: shouldBeClickable() ? "underline" : "none",
                            }}
                          >
                          ...
                          {/* Visa Status Display with Loading */}
                          {visaStatusLoading ? (
                            <div
                              style={{
                                marginTop: "8px",
                          ...
                          {/* Document Status Loading Indicator */}
                          {documentLoading && (
                            <div
                              style={{
                                marginTop: "8px",
                    ...
                    >
                      ...
                      >
                        <span
                          style={{
                            color: shouldBeClickable() ? "#0066cc" : "#666",
                            fontSize: isMobile ? "10px" : "11px",
                            textDecoration: shouldBeClickable() ? "underline" : "none",
                          }}
                        >
